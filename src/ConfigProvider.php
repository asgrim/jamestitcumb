...
final class ConfigProvider
{
    ...
    private function getDependencies(): array
    {
        return [
            ...
            'factories' => [
                Action\AboutAction::class => ReflectionBasedAbstractFactory::class,
                Action\FeedAction::class => ReflectionBasedAbstractFactory::class,
                Action\PostsAction::class => ReflectionBasedAbstractFactory::class,
                Action\TalksAction::class => ReflectionBasedAbstractFactory::class,
                Action\SearchAction::class => ReflectionBasedAbstractFactory::class,
                Action\TrainingAction::class => ReflectionBasedAbstractFactory::class,
